...
namespace Test.Framework
{
    public static class RegexUtils
    {
        ...
        public static readonly Regex HtmlExpression = new Regex(@"<(.|\n)*?>", RegexOptions.Singleline | RegexOptions.Compiled);
        public static readonly Regex SSNExpression = new Regex(@"^\d{9}$", RegexOptions.Singleline | RegexOptions.Compiled);
        public static readonly Regex DigitsOnlyExpression = new Regex(@"[^\d+//]", RegexOptions.Singleline | RegexOptions.Compiled);
        public static readonly Regex PhoneNumberExpression = new Regex(@"^\d{10}$", RegexOptions.Singleline | RegexOptions.Compiled);
        public static readonly Regex ValidDateExpression = new Regex(@"([1-9]|0[1-9]|1[012])[- /.]([1-9]|0[1-9]|[12][0-9]|3[01])[- /.](19|20)\d\d", RegexOptions.Singleline | RegexOptions.Compiled);
    }
}
