...
namespace Test.Framework
{
    ...
    public static class Ensure
    {
        ...
        public static class Argument
        {
            ...
            /// </summary>
            /// <param name="value">Value to test for empty</param>
            /// <param name="paramName">Name of the parameter in the method</param>
            public static void IsNotEmpty(Guid value, string paramName = "")
            {
                That<ArgumentException>(value.IsNotEmpty(), paramName);
            }
            ...
            {
                That<ArgumentException>(value.IsNotNullOrEmpty(), paramName);
            }
            ...
            /// <param name="value">Value to test for empty</param>
            /// <param name="paramName">Name of the parameter in the method</param>
            public static void IsNotOutOfLength(string value, int length, string paramName = "")
            {
                That<ArgumentException>(value.Trim().Length <= length, paramName);
            }

            public static void IsNotNegative(int value, string paramName = "")
            {
                That<ArgumentOutOfRangeException>(value >= 0, paramName);
            }

            public static void IsNotNegativeOrZero(int value, string paramName = "")
            {
                That<ArgumentOutOfRangeException>(value > 0, paramName);
            }
            ...
            public static void IsNotNegativeOrZero(long value, string paramName = "")
            {
                That<ArgumentOutOfRangeException>(value > 0, paramName);
            }
            ...
            public static void IsNotNegativeOrZero(float value, string paramName = "")
            {
                That<ArgumentOutOfRangeException>(value > 0, paramName);
            }

            public static void IsNotNegative(decimal value, string paramName = "")
            {
                That<ArgumentOutOfRangeException>(value >= 0, paramName);
            }

            public static void IsNotNegativeOrZero(decimal value, string paramName = "")
            {
                That<ArgumentOutOfRangeException>(value > 0, paramName);
            }
            ...
            {
                That<ArgumentOutOfRangeException>(value >= TimeSpan.Zero, paramName);
            }

            public static void IsNotNegativeOrZero(TimeSpan value, string paramName = "")
            {
                That<ArgumentOutOfRangeException>(value > TimeSpan.Zero, paramName);
            }

            public static void IsNotEmpty<T>(ICollection<T> value, string paramName = "")
            {
                paramName += "Cannot be Empty";
                IsNotNull(value, paramName);
                IsNotNegativeOrZero(value.Count, paramName);
            }
            public static void IsNotEmpty<T>(IEnumerable<T> value, string paramName = "")
            {
                paramName += "Cannot be Empty";
                IsNotNull(value, paramName);
                That<ArgumentException>(value.Any(), paramName);
            }

            public static void IsNotOutOfRange(int value, int min, int max, string paramName = "")
            {
                That<ArgumentOutOfRangeException>((value < min) || (value > max), string.Format("{0} must be between \"{1}\"-\"{2}\".".FormatWith(paramName, min, max)));
            }

            public static void IsNotInPast(DateTime value, string paramName = "")
            {
                That<ArgumentOutOfRangeException>(value > DateTime.Now, paramName.Trim() + " Should not be in the past");
            }

            public static void IsValidEmail(string value, string paramName = "")
            {
                IsNotEmpty(value, paramName);
                That<ArgumentException>(value.IsEmail(), string.Format("\"{0}\" is not a valid email address.", paramName));
            }
        }
    }
}
